...
@Component({
  selector: 'app-recyclers-list',
  templateUrl: './recyclers-list.component.html',
  styleUrls: ['./recyclers-list.component.scss'],
})
export class RecyclersListComponent implements OnInit {
  ...
  getRepresentativeEntities = () => {
    ...
    this.ecoMembershipService
      .getEcoMemberShipByEcoDuty(ecoDuty.id, 'member_role=recycler')
      .subscribe({
  ...
  edit = (membership: EcoMembership): void => {
    this.router.navigate(['systems/recyclers/form'], {
